...
const SignIn: React.FC = () => {
  ...
  useEffect(() => {
    if (responseQuery.error) {
      setIsOpen(false);
      setMessage("message");
      console.log('responseQuery.error', responseQuery.error)
    }
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            {responseQuery.isLoading ?
              ...
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                {responseQuery.isError &&
                  <div className="flex w-full border-l-6 mb-5 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-4 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-4">
